            ...
            <div class="card">
                <div class="card-header card-header-primary d-flex justify-content-between">
                    <div>
                        ...
                        <p class="card-category"> you have <span>{{ $number_orders }}</span> Confirmed orders </p>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group col-12">
                                                                 ...
                                                                 <div class="dropdown float-right">
                                                                    ...
                                                                    <form method="POST"
                                                                    action="{{ route('deliver_order', $order['id']) }}">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <button class="dropdown-item" type="submit">Delivred</button>
                                                                </form>
