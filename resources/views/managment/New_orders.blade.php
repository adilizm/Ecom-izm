            ...
            <div class="card">
                <div class="card-header card-header-primary d-flex justify-content-between">
                    <div>
                        ...
                        <p class="card-category"> you have <span>{{ $number_orders }}</span> new order </p>
                    </div class="float-right">
                    <a href="{{ route('to_call_back_orders') }}" class="btn" style="
                            ...
                            border-radius: 2px;">To call back <span style=" position: absolute; top: -10px;
          right: -10px;
          padding: 5px 10px;
          border-radius: 50%;
          background-color: red;
          color: white;
            border: 2px solid white;"> {{ $number_call_back }}</span></a>
                </div>
                @if (count($orders) > 0)
                    <div class="card-body">
